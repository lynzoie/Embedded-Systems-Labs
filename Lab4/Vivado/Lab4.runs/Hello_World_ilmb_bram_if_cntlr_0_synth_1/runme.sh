...
HD_PWD='C:/Users/Andi/GIT/Embedded Systems/Embedded-Systems-Labs/Lab4/Lab4.runs/Hello_World_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hello_World_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hello_World_ilmb_bram_if_cntlr_0.tcl
