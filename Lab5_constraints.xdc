...
set_property PACKAGE_PIN U18 [get_ports {ScreenSelect}]
set_property IOSTANDARD LVCMOS33 [get_ports {ScreenSelect}]
...
set_property PACKAGE_PIN J17 [get_ports {Blue[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Blue[0]}]
#Bank = 14, Pin name = ,				Sch name = VGA_G1
set_property PACKAGE_PIN H17 [get_ports {Blue[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Blue[1]}]
#Bank = 14, Pin name = ,					Sch name = VGA_G2
set_property PACKAGE_PIN G17 [get_ports {Blue[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Blue[2]}]
#Bank = 14, Pin name = ,				Sch name = VGA_G3
set_property PACKAGE_PIN D17 [get_ports {Blue[3]}]
