...
set_property PACKAGE_PIN W18 [get_ports Cf]
...
#set_property PACKAGE_PIN T18 [get_ports Ctrl[0]]
#set_property IOSTANDARD LVCMOS33 [get_ports Ctrl[0]]
##Bank = 14, Pin name = ,	Sch name = BTNL
set_property PACKAGE_PIN W19 [get_ports Ctrl[1]]
set_property IOSTANDARD LVCMOS33 [get_ports Ctrl[1]]
##Bank = 14, Pin name = ,							Sch name = BTNR
set_property PACKAGE_PIN T17 [get_ports Ctrl[0]]
set_property IOSTANDARD LVCMOS33 [get_ports Ctrl[0]]
