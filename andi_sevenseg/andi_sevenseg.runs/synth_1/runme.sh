...
HD_PWD='C:/Users/Andi/GIT/Embedded Systems/Embedded-Systems-Labs/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vend_Main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vend_Main.tcl
