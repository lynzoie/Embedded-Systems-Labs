...
HD_PWD='C:/Users/Andi/GIT/Embedded Systems/Embedded-Systems-Labs/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vend_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vend_Main.tcl -notrace
