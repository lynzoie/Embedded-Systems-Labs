...
REM
REM Generated by Vivado on Sun Sep 19 20:35:49 -0400 2021
...
echo "xvlog --incr --relax -prj tb_lab2_vlog.prj"
call xvlog  --incr --relax -prj tb_lab2_vlog.prj -log xvlog.log
